...
type ProCreditParser struct {
	Currency
}

func NewProCreditParser() *ProCreditParser {
	return &ProCreditParser{
		Currency: Currency{
			Id:    enum.LIBERTY,
...
func (g *ProCreditParser) GetName() string {
	return g.Id.String()
}

func (g *ProCreditParser) GetData() ([]Item, error) {
	var items []Item
